...
toolboxes.spm12 = '/home/langdysfun/irichu/Documents/toolboxes/spm12/';  % needed for bias field corr.
toolboxes.nutmeg = '/home/langdysfun/irichu/Documents/toolboxes/nutmeg-master';  % needed for coreg
...
projpath.elec = fullfile(projpath.base, ['elec_positions/sub-', id, '_elec_pos.mat']);
...
try
    ft_defaults %if you already have fieldtrip on path, it works
catch
